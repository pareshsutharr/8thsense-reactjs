...
export function ProfileCard({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden flex flex-col md:flex-row relative">
        
        {/* Left Side: Avatar & Basic Info */}
        <div className="md:w-1/3 flex flex-col items-center text-center p-8 border-b md:border-b-0 md:border-r border-slate-100 relative z-10 bg-white/95 backdrop-blur-md">
          {/* Avatar */}
          ...
          <h2 className="text-3xl font-black text-slate-900 mb-2 tracking-tight">{name}</h2>
        ...
        <div className="md:w-2/3 flex flex-col relative">
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-end p-8 mt-48 md:mt-0 bg-gradient-to-t from-slate-900/90 to-transparent">
            {/* Experience bar */}
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8 bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="text-left">
                <div className="text-3xl font-black text-white mb-1">{formatNumber(animatedLikes)}</div>
                <div className="text-xs text-slate-300 uppercase tracking-widest font-semibold">Total Likes</div>
              </div>
              <div className="text-left border-l border-white/20 pl-4 md:pl-8">
                <div className="text-3xl font-black text-white mb-1">{animatedPosts}</div>
                <div className="text-xs text-slate-300 uppercase tracking-widest font-semibold">Published</div>
              </div>
              <div className="text-left border-l border-white/20 pl-4 md:pl-8">
                <div className="text-3xl font-black text-white mb-1">{formatNumber(animatedViews)}</div>
                <div className="text-xs text-slate-300 uppercase tracking-widest font-semibold">Profile Views</div>
              </div>
            </div>
          </div>
        </div>
